use crate::vendor::layout_key::modifier_symbols::*;
use crate::vendor::layout_key::{KeycodeKind, Label, LayoutKey};
...
pub fn get_basic_layout_key(keycode_bytes: u16) -> Option<LayoutKey> {
    ...
    match keycode {
        ...
        Keycode::KC_ENTER => Some(LayoutKey {
            tap: Label::new("Enter"),
            symbol: Some(crate::vendor::glyphs::ARROW_ELBOW_DOWN_LEFT.to_string()),
        ...
        Keycode::KC_BACKSPACE => Some(LayoutKey {
            ...
            symbol: Some(crate::vendor::glyphs::BACKSPACE.to_string()),
            kind: KeycodeKind::Modifier,
            ..Default::default()
        }),
        Keycode::KC_TAB => Some(LayoutKey {
            tap: Label::new("Tab"),
            symbol: Some(crate::vendor::glyphs::ARROWS_LEFT_RIGHT.to_string()),
            kind: KeycodeKind::Modifier,
            ..Default::default()
        }),
        ...
        Keycode::KC_CAPS_LOCK => Some(LayoutKey {
            ...
            symbol: Some(crate::vendor::glyphs::ARROW_FAT_LINE_UP.to_string()),
            kind: KeycodeKind::Modifier,
            ..Default::default()
        }),
        ...
        Keycode::KC_RIGHT => Some(LayoutKey {
            tap: Label::default(),
            symbol: Some(crate::vendor::glyphs::ARROW_RIGHT.to_string()),
            kind: KeycodeKind::Modifier,
            ..Default::default()
        }),
        Keycode::KC_LEFT => Some(LayoutKey {
            tap: Label::default(),
            symbol: Some(crate::vendor::glyphs::ARROW_LEFT.to_string()),
            kind: KeycodeKind::Modifier,
            ..Default::default()
        }),
        Keycode::KC_DOWN => Some(LayoutKey {
            tap: Label::default(),
            symbol: Some(crate::vendor::glyphs::ARROW_DOWN.to_string()),
            kind: KeycodeKind::Modifier,
            ..Default::default()
        }),
        Keycode::KC_UP => Some(LayoutKey {
            tap: Label::default(),
            symbol: Some(crate::vendor::glyphs::ARROW_UP.to_string()),
            kind: KeycodeKind::Modifier,
            ..Default::default()
        }),
        ...
        Keycode::KC_APPLICATION => Some(LayoutKey {
            tap: Label::new("Menu"),
            symbol: Some(crate::vendor::glyphs::LIST.to_string()),
            ..Default::default()
        }),
        Keycode::KC_KB_POWER => Some(LayoutKey {
            tap: Label::new("Power"),
            symbol: Some(crate::vendor::glyphs::POWER.to_string()),
            ..Default::default()
        }),
        ...
        Keycode::KC_KB_MUTE => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::SPEAKER_X.to_string()),
            ..Default::default()
        }),
        Keycode::KC_KB_VOLUME_UP => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::SPEAKER_HIGH.to_string()),
            ..Default::default()
        }),
        Keycode::KC_KB_VOLUME_DOWN => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::SPEAKER_LOW.to_string()),
            ..Default::default()
        }),
        ...
        Keycode::KC_MEDIA_NEXT_TRACK => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::SKIP_FORWARD.to_string()),
            ..Default::default()
        }),
        Keycode::KC_MEDIA_PREV_TRACK => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::SKIP_BACK.to_string()),
            ..Default::default()
        }),
        Keycode::KC_MEDIA_STOP => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::STOP.to_string()),
            ..Default::default()
        }),
        Keycode::KC_MEDIA_PLAY_PAUSE => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::PLAY_PAUSE.to_string()),
            ..Default::default()
        }),
        ...
        Keycode::KC_MEDIA_FAST_FORWARD => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::FAST_FORWARD.to_string()),
            ..Default::default()
        }),
        Keycode::KC_MEDIA_REWIND => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::REWIND.to_string()),
            ..Default::default()
        }),
        Keycode::KC_BRIGHTNESS_UP => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::SUN.to_string()),
            ..Default::default()
        }),
        Keycode::KC_BRIGHTNESS_DOWN => Some(LayoutKey {
            symbol: Some(crate::vendor::glyphs::SUN_DIM.to_string()),
            ..Default::default()
        }),
        ...
        Keycode::QK_MOUSE_CURSOR_UP => Some(LayoutKey {
            tap: Label::new(crate::vendor::glyphs::ARROW_UP),
            symbol: Some(crate::vendor::glyphs::MOUSE_SIMPLE.to_string()),
            ..Default::default()
        }),
        Keycode::QK_MOUSE_CURSOR_DOWN => Some(LayoutKey {
            tap: Label::new(crate::vendor::glyphs::ARROW_DOWN),
            symbol: Some(crate::vendor::glyphs::MOUSE_SIMPLE.to_string()),
            ..Default::default()
        }),
        Keycode::QK_MOUSE_CURSOR_LEFT => Some(LayoutKey {
            tap: Label::new(crate::vendor::glyphs::ARROW_LEFT),
            symbol: Some(crate::vendor::glyphs::MOUSE_SIMPLE.to_string()),
            ..Default::default()
        }),
        Keycode::QK_MOUSE_CURSOR_RIGHT => Some(LayoutKey {
            tap: Label::new(crate::vendor::glyphs::ARROW_RIGHT),
            symbol: Some(crate::vendor::glyphs::MOUSE_SIMPLE.to_string()),
            ..Default::default()
        }),
        Keycode::QK_MOUSE_BUTTON_1 => Some(LayoutKey {
            tap: Label::new(""),
            symbol: Some(crate::vendor::glyphs::MOUSE_LEFT_CLICK.to_string()),
            ..Default::default()
        }),
        Keycode::QK_MOUSE_BUTTON_2 => Some(LayoutKey {
            tap: Label::new(""),
            symbol: Some(crate::vendor::glyphs::MOUSE_RIGHT_CLICK.to_string()),
            ..Default::default()
        }),
        Keycode::QK_MOUSE_BUTTON_3 => Some(LayoutKey {
            tap: Label::new(""),
            symbol: Some(crate::vendor::glyphs::MOUSE_MIDDLE_CLICK.to_string()),
            ..Default::default()
        }),
        ...
        Keycode::QK_MOUSE_WHEEL_UP => Some(LayoutKey {
            tap: Label::new(crate::vendor::glyphs::ARROW_UP),
            symbol: Some(crate::vendor::glyphs::MOUSE_SCROLL.to_string()),
            ..Default::default()
        }),
