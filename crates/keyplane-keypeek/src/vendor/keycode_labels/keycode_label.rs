use crate::vendor::layout_key::{Label, LayoutKey};
use crate::vendor::keycode_labels::advanced::get_advanced_layout_key;
use crate::vendor::keycode_labels::basic::get_basic_layout_key;
use crate::vendor::keycode_labels::layer::get_layer_layout_key;
