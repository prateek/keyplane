...
fn keycode_label(keycode: &Keycode) -> Option<LayoutKey> {
    match keycode {
        ...
        Keycode::C_RANDOM_PLAY => Some(LayoutKey {
            ...
            symbol: Some(crate::vendor::glyphs::SHUFFLE.to_string()),
            ..Default::default()
        }),
        Keycode::C_REPEAT => Some(LayoutKey {
            tap: Label::with_short("Repeat", "Rpt"),
            symbol: Some(crate::vendor::glyphs::REPEAT.to_string()),
            ..Default::default()
        }),
        ...
        Keycode::C_VOICE_COMMAND => Some(LayoutKey {
            ...
            symbol: Some(crate::vendor::glyphs::MICROPHONE.to_string()),
            ..Default::default()
        }),
        ...
        Keycode::C_AC_NEXT_KEYBOARD_LAYOUT_SELECT => Some(LayoutKey {
            tap: Label::new("Globe"),
            symbol: Some(crate::vendor::glyphs::GLOBE.to_string()),
            ..Default::default()
        }),
    }
}
