...
- OverKeys companion JSON import as a Kanata-ready Best-Effort Preview Import Candidate with row-array fallback geometry, display aliases, Sentinel Key trigger bindings, and profile-owned Kanata TCP settings
