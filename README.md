...
- density-aware structured Display Legend rendering, including layer-tap and QMK mod-tap role slots, and Settings controls for compact, standard, and rich Visual Styles
...
- keyviz style JSON import as a style-only Import Candidate with keycap color tokens
...
- App Window surfaces for the overlay, Import Review with Active Profile diffs and provenance-backed Source Conflicts, Source Inspector, Source Provenance, Backend Health, and Positioning Mode
