...
- App Window surfaces for the overlay, Import Review with Active Profile diffs and provenance-backed Source Conflicts, Source Inspector, Source Precedence, Source Provenance, transparent-entry inheritance, Backend Health, and Positioning Mode
