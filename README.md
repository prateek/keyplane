...
- density-aware structured Display Legend rendering, including layer-tap tap/hold role slots, and Settings controls for compact, standard, and rich Visual Styles
