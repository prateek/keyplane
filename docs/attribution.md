...
`third_party/keypeek` vendors a narrow KeyPeek source snapshot from commit `9c8d4b3f7c30e088367ba361a52eb597e146a276`. The vendored slice includes the keyboard packet loop, Raw HID subscription contract, and VIA/Vial transport paths. Keyplane adapts that source in `src-tauri/src/keypeek_contract.rs` for live layer updates:
